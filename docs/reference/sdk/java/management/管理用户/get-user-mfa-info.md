...
| -------------- | ------ | -------------------------------------------- | ----------------------------------------------------------- | -------------------------------------------- |
| totpStatus     | string | Yes                                          | Yes No Bound to TOTP, optional value enabled, disabled      | `true`                                       |
| faceMfaStatus  | string | Yes                                          | Yes No Bound to face MFA, optional value enabled, disabled  | `true`                                       |
| smsMfaStatus   | string | Yes                                          | Yes No Bound to SMS MFA, optional value enabled, disabled   | `true`                                       |
| emailMfaStatus | string | Yes                                          | Yes No Bound to EMAIL MFA, optional value enabled, disabled | `true`                                       |
