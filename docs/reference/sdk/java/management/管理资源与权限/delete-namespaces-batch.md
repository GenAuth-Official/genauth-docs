...
Batch delete permission groups by permission group unique identifier (Code).
...
| -------- | -------- | -------------------------------------------- | ------------------------------------------- | -------------------------------------------------- | -------------------------------------------- |
| codeList | string[] | Yes                                          | -                                           | Permission group code list Array length limit: 10. | `["code1","code2"]`                          |
