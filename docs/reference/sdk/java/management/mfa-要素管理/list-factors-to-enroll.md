# Get the bindable MFA authentication factors
...
Get all the MFA authentication factors that have been enabled for the application but not yet bound by the user. The user can bind a new MFA authentication factor from the returned list.
