# Get the applications that the user has logged in to
...
Get the application that the user has logged in to through the user ID. You can choose to specify the user ID type, etc.
