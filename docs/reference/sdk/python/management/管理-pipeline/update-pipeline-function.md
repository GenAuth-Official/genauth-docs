...
| funcName        | string | No                                     | -                                           | Function name                                                        | `Registration/login prohibited every Sunday morning from 3:00 to 6:00 a.m. for system maintenance`                                                    |
| funcDescription | string | No                                     | -                                           | Function description                                                 | `Registration/login prohibited every Sunday morning from 3:00 to 6:00 a.m. for system maintenance` System maintenance prohibits registration/login. ` |
