You need to set a callback URL on the configuration page of social login, and the user will be redirected to the callback URL after completing the login.

#### Guide the user to jump to the social login authorization page
...
This operation should be completed in the browser. You can place a clickable button or logo on the web page to link to the above link so that users can click to log in.
