...
为了在小程序中使用 {{$localeConfig.brandName}} 小程序 SDK，你需要先在[微信开放平台](https://mp.weixin.qq.com/)申请一个小程序，同时在 [{{$localeConfig.brandName}} 控制台](https://console.genauth.ai/console/userpool)内填入该小程序的配置。
...
![](https://cdn.genauth.ai/blog/20201112142753.png)

2. 在 [{{$localeConfig.brandName}} 控制台](https://console.genauth.ai/console/userpool)开启微信小程序社会化登录。

- 获取微信小程序 AppId 和 AppSecret

![](https://cdn.genauth.ai/blog/20201112143117.png)

- 前往 [{{$localeConfig.brandName}} 控制台](https://console.genauth.ai/console/userpool) **连接身份源** - **社会化登录** - **小程序内登录**:

![](https://cdn.genauth.ai/blog/20201112143302.png)

- 填入小程序 AppId 和 AppSecret，点击保存即可。

![](https://cdn.genauth.ai/blog/20201112143351.png)
...
<img src="https://cdn.genauth.ai/blog/20201112141931.png" height="400px"></img>

勾选 **使用 npm 模块** 选项：

![](https://cdn.genauth.ai/blog/20201112142118.png)
...
![](https://cdn.genauth.ai/blog/20201112165637.png)
