  ...
  opt =>
        {
          ...
          opt.AppHost: 'https://xxx.genauth.ai',
        }
);
```
...
![](https://cdn.genauth.ai/img/20210414145613.png)
...
- `User.Photo` \<string\> 头像链接，默认为 https://usercontents.genauth.ai/authing-avatar.png
...
- `logoutParam.UserId` \<string\> 用户 id
...
![](https://cdn.genauth.ai/blog/20201019200112.png)
...
![](https://cdn.genauth.ai/img/20210414110024.png)
...
```csharp
var user = await managementClient.BindEmail("demo@genauth.ai", "1234");
```
...
![](https://cdn.genauth.ai/img/20210414105928.png)
...
- `ticket` \<string\> CAS 认证成功后，GenAuth 颁发的 ticket。
