            ...
            >
              <div class="app-logo">
                <img
                  ...
                  "
                  :srcset="`${require('@theme/assets/images/integration/' +
                    item.image2x)} 2x`"
                  :alt="item.name"
                />
              </div>
    ...
    langMap() {
      if (this.$lang === "en-US") {
        return {
          ...
          apnTitle: "Want to join GenAuth APN?",
          apnSubtitle:
            "GenAuth APN is a great way to increase the number of users.",
          apnLink: "Learn more",
        };
      } else if (this.$lang === "zh-CN") {
        return {
          title: "应用集成",
          subtitle: "不要再为登录发愁，GenAuth 集成了所有主流应用 ！",
          apnTitle: "想要加入 GenAuth 合作网络？",
          apnSubtitle:
            "你可以将应用加入到 GenAuth 合作网络，让千万客户快速集成访问",
          apnLink: "了解更多",
        };
      }
    },
