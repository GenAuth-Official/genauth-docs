---
{
  title: "GenAuth 合作网络-应用生态-应用市场，帮助企业管理员和开发者更简单、高效的完成应用单点登录",
  description: "GenAuth 合作网络是一个应用生态，也叫应用市场，为 GenAuth 用户提供更多第三方应用与服务，GenAuth 中的应用能帮助企业管理员和开发者更简单、高效的完成应用单点登录 SSO",
  meta:
    [
      {
        name: "keywords",
        content: "单点登录 SSO，应用生态，应用市场，服务市场，解决方案，项目管理，企业服务，第三方应用，GenAuth，Authing开放平台，Authing应用市场",
      },
    ],
  noSidebar: true,
  ...
  apps: [
      ...
      {
        key: "kingdee-cloud-constellation",
        name: "金蝶云星瀚",
        image: "kdcloud_logo.svg",
        image2x: "kdcloud_logo.svg",
        category: "office",
      },
      {
        key: "guance",
